                ...
                <form 
                 ...
                 >  
                    <div className='bg-[#0000004f] rounded-xl flex flex-col justify-center items-center w-4/5 h-full'>                     
                        ...
                        />
                        <Link to="/login" className='flex justify-center items-center bg-[#FFEEB3] text-[#AC703E] text-2xl font-bold h-12 w-1/4 rounded-full mt-2 hover:bg-[#AC703E] hover:text-[#FFEEB3] duration-300' type='submit'>
                            Enviar 
                        </Link>
                    </div>
                </form>
